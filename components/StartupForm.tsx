	...
	const handleFormSubmit = async (prevState: any, formData: FormData) => {
		try {
		  ...
		  if (result.status == 'SUCCESS') {
				toast.success('Your statup pitch has been created successfully');
	...
	return (
		<form action={formAction} className='startup-form'>
			...
			<div>
				...
				<Input id='category' name='category' className='startup-form_input' required placeholder='Startup Category(Tech, Health, Business ...)' />
